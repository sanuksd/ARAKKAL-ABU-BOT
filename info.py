...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "**{file_name}**\n\n➠ᴄʜᴀɴɴᴇʟ @SanusMoviesCH")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", None)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "𝙏𝙃𝙄𝙎 𝙈𝙀𝙎𝙎𝘼𝙂𝙀 𝙒𝙄𝙇𝙇 𝘽𝙀  𝘿𝙀𝙇𝙀𝙏𝙀𝘿 𝙄𝙉 30 𝙎𝙀𝘾𝙊𝙉𝘿𝙎\n\n 𝙈𝙊𝙑𝙄𝙀 : {title}\n 𝙔𝙀𝘼𝙍 : {year}\n\n 𝙍𝙀𝙌𝙐𝙀𝙎𝙏𝙀𝘿 𝘽𝙔 :  {message.from_user.mention}\n\n\n 𝙈𝘼𝙄𝙉𝙏𝘼𝙄𝙉𝙀𝘿 𝘽𝙔 : @sanusmoviesch ")
