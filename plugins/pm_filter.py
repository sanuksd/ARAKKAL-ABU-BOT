...
async def pm_spoll_choker(msg):
    ...
    await msg.reply("𝗜 𝗰𝗼𝘂𝗹𝗱𝗻'𝘁 𝗳𝗶𝗻𝗱 𝗮𝗻𝘆 𝗺𝗼𝘃𝗶𝗲 𝗶𝗻 𝘁𝗵𝗮𝘁 𝗻𝗮𝗺𝗲 \n click here to <a href=https://www.google.co.in/search?q={query}>𝗰𝗵𝗲𝗰𝗸 𝘁𝗵𝗲 𝘀𝗽𝗲𝗹𝗹𝗶𝗻𝗴</a> \n 𝗣𝗹𝗲𝗮𝘀𝗲 𝗰𝗵𝗲𝗰𝗸 𝘁𝗵𝗲 𝗺𝗼𝘃𝗶𝗲 𝗶𝘀 𝗿𝗲𝗹𝗲𝗮𝘀𝗲𝗱 𝗶𝗻 𝗼𝘁𝘁", reply_markup=InlineKeyboardMarkup(btn), reply_to_message_id=msg.id)
